...
import { Attribute } from "./components/Highlights/Highlights.js";
import { Attribut } from "./components/NewBig/newBig.js";
import { Attribu } from "./components/NewSmall/newSmall.js";
import { Attrib } from "./components/Characters/character.js";
import { Attri } from "./components/BestSeller/bestSeller.js";
import { Att } from "./components/NewReleases/newReleases.js";
class AppContainer extends HTMLElement {
    constructor() {
        ...
        dataHighlights.forEach((data) => {
            const highlightCard = this.ownerDocument.createElement("high-lights");
        ...
        dataNewBig.forEach((data) => {
            const newBigCard = this.ownerDocument.createElement("new-big");
        ...
        dataNewSmall.forEach((data) => {
            const newSmallCard = this.ownerDocument.createElement("new-small");
        ...
        dataBestSeller.forEach((data) => {
            const bestSellerCard = this.ownerDocument.createElement("best-seller");
        ...
        dataNewRelease.forEach((data) => {
            const newReleaseCard = this.ownerDocument.createElement("new-release");
